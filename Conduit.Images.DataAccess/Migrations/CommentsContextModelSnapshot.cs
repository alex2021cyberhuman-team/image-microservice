...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conduit.Images.DataAccess.Articles.ArticleDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Conduit.Images.DataAccess.Authors.AuthorDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Conduit.Images.DataAccess.Comments.CommentDbModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AuthorDbModelAuthorDbModel", b =>
                {
                    b.HasOne("Conduit.Images.DataAccess.Authors.AuthorDbModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Conduit.Images.DataAccess.Articles.ArticleDbModel", b =>
                {
                    b.HasOne("Conduit.Images.DataAccess.Authors.AuthorDbModel", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Conduit.Images.DataAccess.Comments.CommentDbModel", b =>
                {
                    b.HasOne("Conduit.Images.DataAccess.Articles.ArticleDbModel", "Article")
                        .WithMany()
